 ...
 * Brackets the human wait and any durable write with Herdr's blocked-state
 * convention so direct and forwarded prompts report the serving session as blocked.
 */
